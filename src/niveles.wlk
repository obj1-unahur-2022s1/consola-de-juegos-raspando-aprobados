...
object nivel2 inherits Nivel{
	...
	override method configuracion() {
		...
		posicionParedes.addAll([new Position(x=10,y=1),new Position(x=14,y=1), new Position(x=17,y=1),
			                    new Position(x=20,y=1), new Position(x=22,y=1)])	
			
		posicionParedes.addAll([new Position(x=2,y=2), new Position(x=3,y=2), new Position(x=4,y=2), new Position(x=5,y=2), new Position(x=6,y=2),
			                    new Position(x=8,y=2), new Position(x=10,y=2),new Position(x=12,y=2),
		                        new Position(x=15,y=2), new Position(x=19,y=2), new Position(x=20,y=2)])
		
		posicionParedes.addAll([new Position(x=3,y=3),new Position(x=8,y=3),new Position(x=12,y=3),new Position(x=13,y=3),
			                    new Position(x=16,y=3),new Position(x=18,y=3),new Position(x=20,y=3),new Position(x=22,y=3)])
		
		posicionParedes.addAll([new Position(x=1,y=4), new Position(x=4,y=4), new Position(x=5,y=4),new Position(x=7,y=4),new Position(x=9,y=4),
			                    new Position(x=10,y=4), new Position(x=11,y=4), new Position(x=12,y=4),new Position(x=14,y=4),new Position(x=22,y=4)])
		
		posicionParedes.addAll([new Position(x=1,y=5), new Position(x=2,y=5),new Position(x=12,y=5),new Position(x=15,y=5), new Position(x=16,y=5),
			                    new Position(x=17,y=5), new Position(x=18,y=5),new Position(x=20,y=5),new Position(x=22,y=5)])
			                                    
		posicionParedes.addAll([new Position(x=5,y=6), new Position(x=4,y=6),new Position(x=2,y=6),new Position(x=6,y=6),new Position(x=8,y=6),new Position(x=9,y=6),
			                    new Position(x=11,y=6),new Position(x=14,y=6),new Position(x=18,y=6), new Position(x=22,y=6)])
		
		posicionParedes.addAll([new Position(x=5,y=7), new Position(x=9,y=7),new Position(x=15,y=7),
                                new Position(x=18,y=7),new Position(x=19,y=7),new Position(x=21,y=7),new Position(x=22,y=7)])

			                                    
		posicionParedes.addAll([new Position(x=1,y=8),new Position(x=2,y=8), new Position(x=5,y=8),new Position(x=7,y=8),new Position(x=10,y=8),new Position(x=11,y=8),
			                    new Position(x=12,y=8),new Position(x=13,y=8), new Position(x=15,y=8),new Position(x=17,y=8),new Position(x=18,y=8)])
			              
	   posicionParedes.addAll([new Position(x=7,y=9),new Position(x=13,y=9),new Position(x=17,y=9),new Position(x=20,y=9),new Position(x=21,y=9)])
                                
       posicionParedes.addAll([new Position(x=3,y=10), new Position(x=2,y=10),new Position(x=4,y=10), new Position(x=6,y=10),new Position(x=7,y=10),
       	                       new Position(x=8,y=10),new Position(x=9,y=10),new Position(x=10,y=10),new Position(x=12,y=10),new Position(x=13,y=10),new Position(x=15,y=10),
       	                       new Position(x=18,y=10),new Position(x=17,y=10),new Position(x=19,y=10),new Position(x=20,y=10)])     
			                                    
       posicionParedes.addAll([new Position(x=2,y=11),new Position(x=6,y=11),new Position(x=15,y=11),new Position(x=21,y=11)])                      
...
//ARMA
		var armas = [new Position(x=20, y=11)]
			.map{ p => self.crear(new Arma(position = p)) }	
